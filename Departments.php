...
<!-- banner1 -->
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				<li><a href="index.html">Departments</a><i>|</i></li>
				<li>Home</li>
			</ul>
		</div>
	</div>
...
<!-- Portfolio -->
	<div class="portfolio" id="specials">
			...
			<div class="tabs tabs-style-bar">
				<nav>
					<ul>
						<li><a href="#section-bar-1" class="icon icon-box"><span>eye</span></a></li>
						<li><a href="#section-bar-2" class="icon icon-display"><span>cardiology</span></a></li>
						<li><a href="#section-bar-3" class="icon icon-display"><span>gynaecology</span></a></li>
						<li><a href="#section-bar-4" class="icon icon-upload"><span>orthopedic</span></a></li>
					</ul>
				</nav>
				...
				<div class="content-wrap">
					...
					<!-- Tab-1 -->
	<section id="section-bar-1" class="agileits w3layouts" class="width=500 height=600">
						<div class="gallery-grids">
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/p1.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/p1.jpg" alt="Health Plus" style="width:100%;height:250px" >
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top" class="width=500 height=600">
								<a href="images/p3.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/p3.jpg" alt="Health Plus"  style="width:100%;height:250px" >
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top" class="width=500 height=600">
								<a href="images/s3.jpg"  class="swipebox">
									<figure class="effect-apollo">
										<img src="images/s3.jpg"  style="width:100%;height:250px" alt="Health Plus"class="img-responsive">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
					...
					<section id="section-bar-2" class="agileits w3layouts">
						<div class="gallery-grids">
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/r1.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/r1.jpg"  style="width:100%;height:250px" alt="Health Plus" class="img-responsive">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/r2.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/r2.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/r3.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/r3.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
					...
					<section id="section-bar-3" class="agileits w3layouts">
						<div class="gallery-grids">
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/a1.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/a1.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/a2.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/a2.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/a3.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/a3.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
					...
					<section id="section-bar-4" class="agileits w3layouts">
						<div class="gallery-grids">
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/o1.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/o1.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/o2.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/o2.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/o3.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img src="images/o3.jpg" style="width:100%;height:250px" alt="Health Plus">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
