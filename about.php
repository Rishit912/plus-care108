		...
		<div class="header_agileinfo">
						...
						<div class="agileinfo_social_icons">
							<ul class="agileits_social_list">
								...
								<li><a href="#" class="w3_agile_rss"><i class="fa fa-rss" aria-hidden="true">pluscare108@gmail.com</i></a></li>
							</ul>
						</div>
...
<!-- banner1 -->
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				<li><a href="index.html">About</a><i>|</i></li>
				<li>Home</li>
			</ul>
		</div>
	</div>
...
<!-- about -->
	<div class="about" id="about">
		<div class="container">
				<h2 class="w3_heade_tittle_agile">Welcome to our Plus care</h2>
				<br>
				<br>
                ...
                <div class="col-md-6 col-sm-7 w3about-img">
                    <div class="w3about-text">
                        ...
                        <p>hospital, an institution that is built, staffed, and equipped for the diagnosis of disease; for the treatment, both medical and surgical, of the sick and the injured; and for their housing during this process. The modern hospital also often serves as a centre for investigation and for teaching.
                        <p>To better serve the wide-ranging needs of the community, the modern hospital has often developed outpatient facilities, as well as emergency, psychiatric, and rehabilitation services. In addition, “bedless hospitals” provide strictly ambulatory (outpatient) care and day surgery.
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
...
<!-- /girds_agileits -->
        <div class="Department_girds_agileits">
            <div class="agile_team_grid">
                ...
                <div class="col-md-3 w3ls_banner_bottom_grid">
                    <img src="images/o2.jpg" alt=" " class="img-responsive" />
                    <div class="overlay">
                        <h4>Orthopedic</h4>
                        <ul class="social_agileinfo">
                            <li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
			...
			<div class="agile_footer_copy">
				<div class="w3agile_footer_grids">
					<div class="col-md-4 w3agile_footer_grid">
						<h3>About Us</h3>
                        <p>	Our hospital give best service to patients<span>
    ...
    often serves as a centre for investigation and for teaching.</span> </p>
			...
			<div class="w3_agileits_copy_right_social">
				<div class="col-md-6 agileits_w3layouts_copy_right">
                    <p>&copy;Plus care. All rights reserved | Design by Renish pirani, Rishit dangi, Jainam sanghavi</p>
			</div>
