...
<!-- banner1 -->
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				<li><a href="index.html">Contact</a><i>|</i></li>
				<li>Home</li>
			</ul>
		</div>
	</div>
		...
		<div class="container">
           ...
           <div class="contact-top-agileits">
               <div class="col-md-4 contact-grid ">
					<div class="contact-grid1 agileits-w3layouts">
						...
						<div class="con-w3l-info">
						   <h4>Address </h4>
						  <p>PMF9+FXH, Nr. Boda Talav, GIDC Area,<span>Wadhawan City, Gujarat 363030.</span></p>
						</div>
				...
				<div class="col-md-4 contact-grid">
					<div class="contact-grid2 w3">
						...
						<div class="con-w3l-info">
						  <h4>Call Us</h4>
						   <p>+91 9737066224<span><br/>+91 6353726488</span></p>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
				<div class="col-md-4 contact-grid">
					<div class="contact-grid3 w3l">
						...
						<div class="con-w3l-info">
						  <h4>Email</h4>
						  <p><a href="mailto:info@example.com">pluscare108@gmail.com</a>
			...
			<div class="contact-form-aits">
				 <form action="feedback_admin_add_code.php" method="post">
					<input type="text" class="margin-right" name="name" placeholder="name" required="">
					<input type="email" name="email" placeholder="email" required="">
					<input type="text" class="margin-right" name="phone_no" placeholder="phone_no" required="">
