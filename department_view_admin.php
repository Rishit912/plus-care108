...
if(isset($_GET['Department_id']))
{
    ...
    $qd="delete from department where Department_id='$Department_id'";
...
<!-- banner1 -->
	<div class="banner1 jarallax">
		...
		<br>
		<br>
		<h1 style="color:white;text-align: center;">View department</h1>
		</div>
	</div><he>
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				<button type="button"style="float:left" ><a href="department_add_admin.php">Add Department</button>
					</ul>
		</div>
	</div>
	<div>
   ...
   <table class="table table-bordered" >
        ...
        <tr>
            ...
            <td>
			<a href="department_edit_admin.php?Department_id=<?php print $row['Department_id'];?>">Edit</a> || 
			<a href="department_view_admin.php?Department_id=<?php print $row['Department_id'];?>" onclick="return confirm('Are you sure?')">Delete</a>
		</td>
        </tr>
        <?php } ?> 
    </table>
