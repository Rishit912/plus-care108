...
<!-- //banner1 -->
<form action="doctor_admin_add_code.php" enctype="multipart/form-data" method="post">
...
<input type="text" name="Doctor_mobileNo" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
     <label for="birthdate">Birthdate</label>
<input type="date" name="birthdate" class="form-control" id="birthdate" onchange="calculateAge()">
...
<input type="text" class="form-control" name="Language" id="exampleInputEmail1" aria-describedby="emailHelp">
...
<input type="text" class="form-control" name="Bloodgroup" id="exampleInputEmail1" aria-describedby="emailHelp">
<label for="exampleInputaddres" class="form-label">AadhaarCardNo</label><br>
<input type="text" class="form-control" name="AadhaarCardNo" id="exampleInputEmail1" aria-describedby="emailHelp">
...
<input type="text" class="form-control" name="Pincode" id="exampleInputEmail1" aria-describedby="emailHelp">
...
<label for="exampleInputspecilization" class="form-label">Department_id</label><br>
...
<input type="text" class="form-control" name="specialization" id="exampleInputEmail1" aria-describedby="emailHelp">
<label for="exampleInputspecilization" class="form-label">experience</label><br>
<input type="text" class="form-control" name="experience" id="exampleInputEmail1" aria-describedby="emailHelp">
<div class="mb-3">
