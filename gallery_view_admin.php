...
{
    $G_id = $_GET['G_id'];
	$qd="delete from gallery where G_id=$G_id";
...
<!-- banner1 -->
	<div class="banner1 jarallax">
		...
		<h1 style="color:white;text-align: center;">View gallery</h1>
		</div>
	</div>
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
			<button type="button"style="float:left" ><a href="gallery_admin_add_.php">Add gallery</button>
				</ul>
		</div>
	</div>
...
<!-- //banner1 -->
		...
		<tr>
			...
			<td> <img src="<?php print $row['File']?>" style="width:200px;height:200px"></td>
			<td><a href="gallery_view_admin.php?G_id=<?php print $row['G_id'];?>"
