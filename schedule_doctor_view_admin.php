...
{
    $Sc_id=$_GET['S_id'];
    $qd="delete from schedule where S_id='$Sc_id'";
...
<!-- banner1 -->
	<div class="banner1 jarallax">
		...
		<h1 style="color:white;text-align: center;">View schedule</h1>
		</div>
	</div><hr>
	<div class="services-breadcrumb">
		<button type="button"style="float:left" ><a href="schedule_doctor_add__admin.php">Add schedule</button>
		<div class="container">
		</div>
	</div>
...
<!-- //banner1 -->
        ...
        $q="select d.D_name,s.* from schedule s ,doctor d where d.D_id=s.Doctor_id";
        ...
        <tr>
            ...
            <td><a href="schedule_doctor_view_admin.php?S_id=<?php print $row['S_id'];?>"
